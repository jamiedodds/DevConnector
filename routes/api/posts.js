...
router.post(
    ...
    async (req, res) => {
        ...
        try {
            ...
            res.status(500).send('Server error - Create a post');
        }
    }
);
...
router.post(
    ...
    async (req, res) => {
        ...
        try {
            ...
            console.error(err.message);
            res.status(500).send('Server error - Comment on a post');
        }
    }
);
...
router.delete('/comment/:id/:comment_id', auth, async (req, res) => {
    try {
        ...
        console.error(err.message);
        res.status(500).send('Server error - Delete comment on a post');
    }
});
